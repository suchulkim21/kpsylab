...
import { ADDITIONAL_QUESTIONS } from "@growth-roadmap/data/module2/additionalQuestions";
...
export default function AdditionalQuestionsPage() {
    ...
    useEffect(() => {
        ...
        if (!stored) {
            router.push('/growth-roadmap/module2');
            return;
        }
    }, [router]);
    ...
    const handleComplete = async (finalSelections: ScenarioOption[]) => {
        try {
            ...
            // 일관성 재검사
            const { checkAnswerConsistency } = await import('@growth-roadmap/lib/module2/consistencyCheck');
    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4 relative">
            ...
            <div className="absolute top-4 left-4 z-20">
                <Link href="/growth-roadmap/module2/result" className="text-gray-400 hover:text-white transition-colors flex items-center gap-2">
                    <Home size={24} />
