...
const PHASE_1_VARIANTS: PhaseVariant[] = [
  {
    ...
    message: `흥미롭습니다. 당신의 선택에서 일관된 패턴이 감지되기 시작했습니다. 겉으로 드러난 성향 뒤에 숨겨진 '본능'을 조금 더 파고들어야 명확해질 것 같습니다.

지금까지의 질문은 자기 인식, 권리 의식, 위기 상황에서의 선택 경향을 살펴본 것입니다. 다음 단계에서는 갈등·경쟁·관계 속에서의 판단을 더 깊이 분석하여, 당신만의 '다크 네이처' 윤곽을 잡겠습니다.`,
    insights: [
      "자기 평가와 타인에 대한 기대에서 일관된 축이 감지되었습니다.",
      "위기·압박 상황에서의 선택 패턴이 수집 중입니다.",
      "2단계에서 갈등·경쟁·도덕적 경계 질문으로 심층 분석을 진행합니다.",
    ],
    buttonLabel: "심층 분석 계속하기 (2단계)",
  },
  {
    title: "1단계 분석 완료",
    subtitle: "14개 문항의 응답이 분석에 반영되었습니다.",
    message: `당신의 첫 14개 응답을 바탕으로 예비 프로파일이 생성되고 있습니다. 아직 결론을 내리기에는 데이터가 부족하지만, 몇 가지 가설이 이미 서 있습니다.

2단계에서는 승진·경쟁·배신·복수 같은 구체적 상황에서의 판단을 묻습니다. 그 답들이 지금까지의 패턴을 확정하거나, 전혀 다른 면을 드러낼 수 있습니다.`,
    insights: [
      "나르시시즘·마키아벨리즘·도덕적 이탈 관련 응답 패턴 수집이 완료되었습니다.",
      "다음: 사이코패시·사디즘·상황 시나리오 문항으로 교차 검증을 진행합니다.",
      "완료 시 당신 전용 '다크 네이처' 리포트가 생성됩니다.",
    ],
    buttonLabel: "심층 분석 계속하기 (2단계)",
  },
  {
    title: "1단계 분석 완료",
    subtitle: "기본 성향 레이어 분석이 완료되었습니다.",
...
2단계와 3단계에서 갈등, 경쟁, 관계, 규칙 위반에 대한 구체적 선택을 묻고, 이를 1단계 데이터와 합쳐 최종 프로파일을 산출합니다.`,
    insights: [
      "자기 우월감·특별 대우·도덕적 유연성 관련 지표 1차 산출이 완료되었습니다.",
      "2단계에서 충동성·공감·경쟁·복수 심리를 추가로 측정합니다.",
      "3단계에서 검증 문항과 일관성 쌍으로 신뢰도를 보정합니다.",
    ],
    buttonLabel: "심층 분석 계속하기 (2단계)",
  },
];
...
const PHASE_2_VARIANTS: PhaseVariant[] = [
  {
    ...
    message: `이제 윤곽이 잡혔습니다. 당신은 특정 상황에서 매우 독특한 판단 기준을 가지고 있습니다. 28개 문항의 응답을 교차 분석한 결과, 몇 가지 성향 축이 안정적으로 추정되고 있습니다.

마지막 14문항에는 검증 문항과 일관성 확인용 문항이 포함되어 있습니다. 솔직하게 답할수록 최종 '다크 네이처' 리포트의 정확도가 올라갑니다. 이제 마지막 몇 가지 질문으로 당신의 프로파일을 확정하겠습니다.`,
    insights: [
      "갈등·경쟁·복수·도덕적 경계에서의 선택 패턴 분석이 완료되었습니다.",
      "나르시시즘·마키아벨리즘·사이코패시·사디즘 4축 예비 점수가 산출되었습니다.",
      "3단계: 검증·일관성 반영 후 최종 리포트를 생성합니다.",
    ],
...
3단계에는 '솔직히 답했다'는 검증 문항과, 비슷한 질문을 다른 표현으로 한 일관성 문항이 포함됩니다. 이 단계를 마치면 당신만의 다크 테트라드·하위 요인 해석과 최종 시나리오가 생성됩니다.`,
    insights: [
      "상황 시나리오·도덕적 이탈·사디즘·악의성 관련 데이터 수집이 완료되었습니다.",
      "4대 어두운 특성(마키아벨리즘·나르시시즘·사이코패시·사디즘) 예비 프로파일이 산출되었습니다.",
      "마지막 14문항으로 신뢰도를 보정한 뒤 최종 결과를 공개합니다.",
    ],
    buttonLabel: "마지막 확인하기 (3단계)",
  },
  {
    title: "2단계 분석 완료",
    subtitle: "심층 패턴 분석이 거의 완료되었습니다.",
    message: `당신은 특정 상황에서 매우 독특한 판단 기준을 가지고 있습니다. 지금까지의 선택은 '겉으로 드러난 태도'와 '갈등·압박 속에서의 실제 선택'이 잘 맞아떨어지는 편인지, 아니면 갈라지는 지점이 있는지까지 보여 주고 있습니다.

마지막 단계에서는 검증 문항으로 응답 신뢰도를 보정하고, 일관성 쌍으로 분석 정확도를 높입니다. 3단계를 완료하면 당신의 다크 네이처가 최종 확정됩니다.`,
    insights: [
      "이기주의·권리의식·도덕적 이탈·악의성(D요인) 2차 지표가 반영되었습니다.",
      "다음: 검증 4문항과 일관성 쌍(n1/n1b, m1/m1b)으로 최종 산출을 진행합니다.",
      "완료 시 아키타입·하위 요인 해석·최종 리스크 시나리오를 제공합니다.",
    ],
    buttonLabel: "마지막 확인하기 (3단계)",
  },
];
        ...
        {!showContent ? (
          ...
          >
            ...
            <p className="text-xs text-gray-500">
              응답 패턴을 심층 분석하고 있습니다. 잠시만 기다려 주세요.
            </p>
          </motion.div>
        ) : (
          <motion.div
