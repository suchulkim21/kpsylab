...
export const DARK_NATURE_QUESTIONS: Question[] = [
  ...
  { id: 'p1', category: 'darkTetrad', trait: 'psychopathy', subFactor: 'egoism', text: '나는 뒷일은 생각하지 않고 기분 내키는 대로 행동하곤 한다.', order: 15 },
  ...
  { id: 'sp4', category: 'dFactor', subFactor: 'spitefulness', text: '누군가 나를 무시하면, 반드시 기억해 두었다가 어떤 방식으로든 대가를 치르게 해야 직성이 풀린다.', order: 38 },
  { id: 'v7', category: 'validation', text: '솔직히, 사회적으로 비난받을 만한 생각은 숨기고 답변한 적이 있다.', order: 39, isReverse: true },
  { id: 'v4', category: 'validation', text: '지금 선택하고 있는 답변들은 나의 실제 성격과 일치한다.', order: 40 },
